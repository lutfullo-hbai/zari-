...
class TestLLMRouting:
    ...
    def test_disambiguate_with_llm(self):
        """Test LLM disambiguation"""
        result = disambiguate_with_llm("music search", ["music", "search"])
        
        assert result in ["music", "search"]
    
    def test_disambiguate_single_candidate(self):
        """Test disambiguation with single candidate"""
        result = disambiguate_with_llm("query", ["music"])
        
        assert result == "music"
    
    def test_disambiguate_empty_candidates(self):
        """Test disambiguation with no candidates"""
        result = disambiguate_with_llm("query", [])
