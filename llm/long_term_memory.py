...
_STOPWORDS = {
    "salom", "assalom", "zari", "bor", "yoq", "bilan", "uchun", "bu", "shu",
    "men", "sen", "u", "biz", "siz", "ular", "mening", "sening", "uning", "bir",
    "nima", "qanday", "qayerda", "qachon", "kim", "nega", "ha", "yo'q", "endi",
    "hozir", "kerak", "bo'ladi", "bo'ldi", "qil", "ber", "ayt", "the", "and",
    "what", "how", "why", "when", "where", "can", "you", "your", "for", "this",
}
